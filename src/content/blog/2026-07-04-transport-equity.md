...
Providing access for disabled and aging riders is important. Most buses are low-floor with ramps and wheelchair spaces, and all train stations except Heyington do support wheelchair, strollers, and mobility aids. However in 2023-24, [only 18% of tram services were accessable.](https://www.audit.vic.gov.au/report/accessibility-tram-services-follow?section=#key-facts:~:text=Key%20background%20information) When relying on a legacy network that runs high-floor trams on stops that do not provid elevel-access, both need to be upgraded and an accelerated rollout is needed to meet the Disability Standards for Accessible Public Transport guidelines. Forcing vunreable riders onto more expensive modes
...
Universal design benefits all riders, where platform stops separate passengers from traffic, and wheelchair spaces and level boarding providing space for prams, and support travellers with luggage, injured, elderly, etc. Forcing vunreable riders onto more expensive modes erases the benefits of subsidising public transit fares. 
...
---
The most polarizing topic in Melbourne has been the viability of the Suburban Rail Loop. It's swept other major infrastructure projects under the rug, and appeared to left no money for increasing service levels. I set to find out how useful the multi-billion dollar project will be, and how we can improve it's effectiveness to create a modern multi-modal network. 
...
**[SRL Glen Waverley](https://mohanwadia.com/srl/?mode=isochrone&point=-37.880029%2C145.162885)** currently has only has one frequent bus route (Route 902), [which has the highest patronage of all non-shuttle routes](https://mohanwadia.com/blog/posts/patronage-analysis/#:~:text=The%20number%20of%20service%20hours%20of%20a%20route%20has%20the%20strongest%20association%20with%20patronage.%20Therefore%2C%20I%20will%20use%20Service%20Duration%20as%20the%20independent%20variable%20in%20the%20following%20visual%20analysis.), despite it's large bus interchange. Treatment 2 provide the precinct with 4 high-frequency buses: A Route 902 which continues to the City from Doncaster SC, a Route 734 extended to Knox City SC, an extended and straightened Route 623 along Waverley Rd to Caulfield RS, and a new route towards Dandenong via Wheelers Hill SC.
